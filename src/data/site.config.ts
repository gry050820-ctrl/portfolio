...
export const siteConfig = {
    ...
    metrics: [
      {
        ...
        evidence: [
          { label: "AI U 盘 · 知识管理工具", href: "/project/ai-usb" },
        ...
        projects: [
          {
            ...
            number: 1,
            name: "AI U 盘",
            conflict: "很多学生不会真正用 AI 学习。他们在多门课程间切换时，学习资料散落在 3-5 个平台，缺乏统一的整理和检索方式。",
            motivation: "我做了一个知识管理工具，让 AI 帮学生自动整理和检索学习资料。",
    ...
    nodes: [
      {
        ...
        icon: "🔍",
        title: "发现问题",
        summary: "不是从'我想做 AI U 盘'开始，而是从'为什么学生不用 AI 学习'开始",
        method: [
          "观察用户行为——不是问他们想要什么，而是看他们实际在做什么",
          "找到重复出现的挫折点——学生在 3-5 个平台间反复切换找资料",
          "定义问题而非定义解决方案——用户说想要'更好的搜索'，实际需要'更少的东西要搜'",
        ],
        keyInsight: "用户说的 ≠ 用户需要的。产品经理的价值不是记录需求，而是翻译需求。",
        evidenceAnchors: [
      ...
      },
      {
        ...
        icon: "🧠",
        title: "思考方案",
        summary: "不是'想一个功能就做一个功能'，而是'先定义用户故事，再设计方案'",
        method: [
          "画出用户旅程，找到最高摩擦点——资料整理环节耗时最长、体验最差",
          "定义 MVP 范围——只做能验证核心假设的功能（自动整理 + 检索）",
          "用 AI 快速生成原型——3 天出了 3 版原型，快速获取反馈",
        ],
        keyInsight: "MVP 的目标不是'做出来'，而是'用最小的成本验证最核心的假设'。",
        evidenceAnchors: [
      ...
      },
      {
        ...
        icon: "⚖️",
        title: "取舍决策",
        summary: "不是'能做就做'，而是'主动放弃，聚焦关键假设'",
        method: [
          "列出所有可能方案（2-3 个）——不做无限枚举，聚焦有意义的选项",
          "评估每个方案的代价和风险——时间、复杂度、用户接受度",
          "选择能最快验证假设的方案——放弃全功能 MVP，只做单功能深挖",
          "明确记录放弃了什么、为什么——放弃了笔记编辑和协作功能",
        ],
        keyInsight: "产品经理最大的能力不是选择，而是放弃。说'不'比说'好'更需要判断力。",
        evidenceAnchors: [
      ...
      },
      {
        ...
        icon: "🤖",
        title: "AI 加速",
        summary: "不是'用 AI 做了一切'，而是'AI 负责__, 我负责__'",
        method: [
          "AI 负责：PRD 初稿生成、用户反馈自动分类、代码框架搭建、语义搜索的 embedding 计算",
          "我负责：问题定义和产品方向、所有关键取舍决策、AI 输出质量判断和修正、用户访谈和需求验证",
          "关键原则：AI 是杠杆，不是替代品。它放大了我的执行力，但不替代我的判断力。",
        ],
        keyInsight: "AI 提高效率之前，先要重新定义流程。把 AI 塞进旧流程是浪费，围绕 AI 能力设计新流程才是杠杆。",
        evidenceAnchors: [
      ...
      },
      {
        ...
        method: [
          "定义北极星指标——不是虚荣指标（注册数），而是行为指标（使用 3 次以上的用户占比）",
          "收集真实用户反馈——不是想象中的用户，而是真正用过的用户",
          "对比假设 vs 实际结果——假设'整理是核心痛点'→ 用户留存数据支持这个假设",
          "区分'做得对'和'运气好'——数据上涨不一定是做对了，要理解因果关系",
        ],
  ...
  timeline: [
    ...
    },
    {
      ...
      description:
        "完成了 AI U 盘的从 0 到 1——需求调研、PRD、原型、开发、用户测试、迭代。第一次完整经历了一个产品从想法到落地的全过程，也是第一次深刻理解'用户说的 ≠ 用户需要的'。",
      highlight: "从学习者到实践者",
    },
    {
      date: "2024 末 — 2025 初",
