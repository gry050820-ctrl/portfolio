...
export const siteConfig = {
    ...
    metrics: [
      {
        ...
        evidence: [
          ...
          { label: "GEO Analyst Workspace", href: "/project/geo-analyst-workspace" },
          { label: "Personal Context OS", href: "/project/personal-context-os" },
        ],
        lastUpdated: "2026.07",
        clickable: true,
      },
      {
        ...
        evidence: [
          ...
          { label: "Personal Context OS · 知识治理", href: "/project/personal-context-os" },
          { label: "GEO · 多平台采集与复测", href: "/project/geo-analyst-workspace" },
        ],
        lastUpdated: "2026.07",
        clickable: true,
      },
      {
        ...
        evidence: [
          ...
          { label: "GEO · 从诊断到复测", href: "/project/geo-analyst-workspace" },
          { label: "Personal Context OS · 从捕获到召回", href: "/project/personal-context-os" },
        ],
        lastUpdated: "2026.07",
        clickable: true,
      },
  ...
  lab: {
    explorations: [
      ...
      {
        question: "AI 如何建立可信的长期上下文？",
        projects: [
          {
            slug: "personal-context-os",
            number: 4,
            name: "Personal Context OS",
            conflict: "AI 能完成一次任务，却容易忘记用户的长期目标、历史决策和项目经验；知识越积越多，来源、时效和置信度反而越难管理。",
            motivation: "我用 Obsidian、Markdown 和 Codex 建立了一套个人上下文系统，让对话能够被证据化捕获、分层治理，并在后续项目中主动召回。",
            status: "iterating" as const,
            statusLabel: "持续迭代",
            role: "产品设计 · 信息架构 · AI 工作流",
            tags: ["Context Engineering", "Obsidian", "AI Memory", "Automation"],
            result: "跑通 Memory Capture、Query-first、Daily Triage、Weekly Lint 和 Project Digest 的长期上下文闭环",
            period: { start: "2026-07" },
            coverIcon: "CTX",
          },
        ],
  ...
  capabilities: [
    {
      ...
      levels: [
        ...
        },
        {
          ...
          evidence: { label: "Personal Context OS · 记忆治理判断", slug: "personal-context-os" },
        },
        {
          level: 4,
          label: "洞察",
      ...
      relatedProjects: ["ai-usb", "personal-context-os", "geo-analyst-workspace"],
    },
    {
      id: "design",
      icon: "✏️",
      ...
      levels: [
        ...
        },
        {
          ...
          evidence: { label: "Personal Context OS · 上下文生命周期", slug: "personal-context-os" },
        },
        {
          level: 4,
          label: "系统",
      ...
      relatedProjects: ["ai-usb", "personal-context-os"],
    },
    {
      id: "ai-practice",
      icon: "🤖",
      ...
      levels: [
        ...
        },
        {
          ...
          evidence: { label: "GEO · 多平台 AI 采集", slug: "geo-analyst-workspace" },
        },
        {
          level: 3,
          label: "编排",
          description: "能设计 Agent 协作流程，自动化复杂任务",
          evidence: { label: "Personal Context OS · Agent 知识治理", slug: "personal-context-os" },
        },
        {
          level: 4,
          label: "产品化",
      ...
      relatedProjects: ["video-pipeline", "personal-context-os", "geo-analyst-workspace", "ai-usb"],
    },
    {
      id: "execution",
      icon: "🚀",
      ...
      levels: [
        ...
        },
        {
          ...
          evidence: { label: "GEO · 从基线到成果报告", slug: "geo-analyst-workspace" },
        },
        {
          level: 4,
          label: "推动",
      ...
      relatedProjects: ["ai-usb", "video-pipeline", "geo-analyst-workspace"],
    },
    {
      id: "communication",
      icon: "📝",
      ...
      levels: [
        ...
        },
        {
          ...
          evidence: { label: "GEO · 数据与归因边界", slug: "geo-analyst-workspace" },
        },
        {
          level: 4,
          label: "叙事",
      ...
      relatedProjects: ["ai-usb", "geo-analyst-workspace", "personal-context-os"],
    },
  ],
    ...
    nodes: [
      ...
      },
      {
        ...
        evidenceAnchors: [
          ...
          { label: "Personal Context OS · AI 上下文治理", slug: "personal-context-os" },
        ],
      },
      {
        id: "validate",
  ...
  timeline: [
    {
      ...
      title: "第一次认真用 AI",
      description:
        "不是浅尝辄止地'试一下'，而是开始把 AI 融入日常学习和工作。这个阶段建立了对 AI 能力边界的基本认知——它不只是聊天工具，能真正辅助思考和生产。",
      highlight: "从好奇到认真",
    },
    {
      date: "2025 中",
      title: "在真实业务中理解产品",
      description:
        "通过实习进入真实业务场景，面对真实用户、真实数据和真实约束。这个阶段最大的收获是：产品不是功能列表，而是问题 × 用户 × 约束的交集。",
      highlight: "从个人练习到企业实战",
    },
    {
      date: "2026 初",
      title: "把 AI 当作系统来设计",
      description:
        "开始深入探索 Claude Code 和 AI Agent 方向。认知升级的关键：AI 不只是单次问答工具，而是可以被编排成自动化系统的。从'用 AI'到'设计 AI 的工作方式'。",
      highlight: "从使用工具到编排工作流",
    },
    {
      date: "2026.05",
      title: "跑通完整的产品闭环",
      description:
        "独立完成了 AI U 盘和视频流水线。第一次完整经历：发现真实问题 → 设计方案 → 取舍决策 → AI 加速执行 → 验证结果 → 复盘迭代。验证了'产品思维 + AI 执行'这个组合的威力。",
      highlight: "从发现问题到验证结果",
    },
    {
      date: "现在",
      title: "持续构建，持续思考",
      description:
        "这些项目不是随机拼凑的——它们都围绕着同一个问题：如何用 AI 和产品思维，把真实问题变成可运行的解决方案。这个作品集本身就是这个问题的持续实践。",
      highlight: "一直在路上",
    },
  ],
